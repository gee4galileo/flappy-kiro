...
- [ ] 2. GameState enum and Game class skeleton
  ...
  - [ ]* 2.1 Write unit tests for state transitions
...
- [ ] 3. PhysicsEngine
  ...
  - [ ]* 3.1 Write property test P1: Flap sets velocity to FLAP_VELOCITY
    - **Property 1: Flap sets velocity to FLAP_VELOCITY**
    - **Validates: Requirements 2.4, 3.2**

  - [ ]* 3.2 Write property test P2: Physics halted while Paused
    - **Property 2: Physics halted while Paused**
    - **Validates: Requirements 2a.2**

  - [ ]* 3.3 Write property test P3: Flap ignored while Paused
    - **Property 3: Flap ignored while Paused**
    - **Validates: Requirements 2a.5**

  - [ ]* 3.4 Write property test P4: Gravity accumulates velocity each frame
    - **Property 4: Gravity accumulates velocity each frame**
    - **Validates: Requirements 3.1**

  - [ ]* 3.5 Write property test P5: Position updated by velocity each frame
    - **Property 5: Position updated by velocity each frame**
    - **Validates: Requirements 3.3, 3.5**

  - [ ]* 3.6 Write property test P6: Terminal velocity is enforced
    - **Property 6: Terminal velocity is enforced**
    - **Validates: Requirements 3.4**

  - [ ]* 3.7 Write property test P7: Delta-time proportionality
...
- [ ] 4. InputHandler
  ...
  - [ ]* 4.1 Write unit tests for InputHandler
...
- [ ] 5. Pipe and cloud spawning and scrolling
  ...
  - [ ]* 5.1 Write property test P8: Obstacles scroll left each frame
    - **Property 8: Obstacles scroll left each frame**
    - **Validates: Requirements 4.2, 5.2**

  - [ ]* 5.2 Write property test P9: Off-screen obstacles are removed
    - **Property 9: Off-screen obstacles are removed**
    - **Validates: Requirements 4.4, 5.4**

  - [ ]* 5.3 Write property test P10: Gap bounds invariant
...
- [ ] 6. CollisionDetector
  ...
  - [ ]* 6.1 Write property test P11: Pipe collision detection
    - **Property 11: Pipe collision detection**
    - **Validates: Requirements 6.1**

  - [ ]* 6.2 Write property test P12: Boundary collision detection
    - **Property 12: Boundary collision detection**
    - **Validates: Requirements 6.2**

  - [ ]* 6.3 Write property test P13: Cloud collision detection
...
- [ ] 7. ScoreManager
  ...
  - [ ]* 7.1 Write property test P14: High score persistence round-trip
    - **Property 14: High score persistence round-trip**
    - **Validates: Requirements 6.6, 6.7, 7.2, 7.5**

  - [ ]* 7.2 Write property test P15: Score increments on pipe pass
    - **Property 15: Score increments on pipe pass**
    - **Validates: Requirements 7.1**

  - [ ]* 7.3 Write property test P16: Score resets to zero on game reset
    - **Property 16: Score resets to zero on game reset**
    - **Validates: Requirements 7.4**

  - [ ]* 7.4 Write unit tests for ScoreManager edge cases
...
- [ ] 9. Visual effects (particles, screen shake, score popups)
  ...
  - [ ]* 9.1 Write property test P17: Screen shake created on collision
    - **Property 17: Screen shake created on collision**
    - **Validates: Requirements 11.1**

  - [ ]* 9.2 Write property test P18: Particle emitted each Playing frame
    - **Property 18: Particle emitted each Playing frame**
    - **Validates: Requirements 11.2**

  - [ ]* 9.3 Write property test P19: Score popup created on score increment
    - **Property 19: Score popup created on score increment**
    - **Validates: Requirements 11.3**

  - [ ]* 9.4 Write property test P20: Expired effects are removed each frame
